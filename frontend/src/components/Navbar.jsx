...
export const Navbar = () => {
  ...
  // ============================================================
  // OFFICIAL MUNICIPAL COMMAND CENTER HEADER (Single Top Header - No Duplicate Nav)
  // ============================================================
  if (isOfficial) {
    return (
      <header className="sticky top-0 z-40 bg-slate-900 border-b border-slate-800 text-white">
        <div className="w-full px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16 gap-3">
            ...
            <form onSubmit={handleSearchSubmit} className="flex-1 max-w-md hidden md:block">
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full bg-white text-slate-900 text-xs pl-8 pr-3 py-2 rounded-md border-none focus:outline-none focus:ring-2 focus:ring-blue-600 placeholder:text-slate-400"
                />
              </div>
            </form>
            ...
            <div className="flex items-center space-x-2 sm:space-x-3">
              ...
              {/* Mobile Hamburger Toggle for Mobile Web App Drawer */}
              <button
                onClick={() => setMobileMenuOpen(!mobileMenuOpen)}
                className="lg:hidden p-1.5 rounded text-slate-300 hover:text-white hover:bg-slate-800"
        ...
        {/* Mobile Navigation Drawer for Mobile Screens */}
        {mobileMenuOpen && (
  ...
  // ============================================================
  // CITIZEN PUBLIC SERVICES HEADER (Single Clean White Header)
  // ============================================================
  return (
    <header className="sticky top-0 z-40 bg-white border-b border-slate-200">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* Mobile Navigation Drawer for Citizen Mode */}
        {mobileMenuOpen && (
